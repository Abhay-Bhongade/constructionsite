  ...
  return (
    ...
    >
      <div className="row mx-2">
        <h1 className="text-center my-5 headinginproduct">Featured Products</h1>
        <div className="col-md-12">
          <Slider {...settings} className="slider-container">
            <div className="card mx-2" style={{ width: "14.5rem" }}>
              <img className="card-img-top" src={one} alt="Card image cap" />
              <div className="card-body">
                <h5 className="card-title">Kay Beauty Contour Stick</h5>
                <p className="card-text">17 Shades</p>
